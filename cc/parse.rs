...
pub enum ParseResult<T> {
  Ok((T, String)),                        // parser succeeded without ever backtracking
  Err((Expecteds, String)),               // parser failed
  Both((T, String), (Expecteds, String)), // parser succeeded after backtracking from failure
}
