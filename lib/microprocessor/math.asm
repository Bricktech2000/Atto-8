...
c8f8! !i32 # c8f8 n = c8f8(i16 im, i16 re)
...
u8f8.add! !u16.add
i8f8.add! !i16.add
c8f8.add! !i8f8.add clc !i8f8.add
...
u8f8.sub! !u16.sub
i8f8.sub! !i16.sub
c8f8.sub! !i8f8.sub clc !i8f8.sub
...
u8f8.mul! !u16.mul pop ld1 st2 st0 # u8f8 product = u8f8.mul(u8f8 a, u8f8 b)
i8f8.mul! !i16.mul pop ld1 st2 st0 # i8f8 product = i8f8.mul(i8f8 a, i8f8 b)
...
u8.mul_def!
  u8.mul: clc # u16 r = u8.mul(u8 a, u8 b)
    !u16.0 # result
    x08 for_bit. dec
      # b >>= 1
  ...
  !u16.st0+1 !ret
i8.mul_def!
  i8.mul: clc # i16 r = i8.mul(i8 a, i8 b)
    # u16 r = (u8)a * (u8)b
    !u16.0 # result
    x08 for_bit. dec
      !u8.ld3+2 !u8.shr !u8.st3+2
...
u16.mul_def!
  ...
  !u32.st0+1 !ret
i16.mul_def!
  i16.mul: clc # i32 r = i16.mul(i16 a, i16 b)
    # u32 r = (u16)a * (u16)b
    !u32.0 # result
    x10 for_bit. dec
      !u16.ld3+2 !u16.shr !u16.st3+2
